codeunit 50100 TaskletSubscriber
{
    ...
    //Tweak: Text;
    begin
        _MobTweakContainer.Add(6182300, 'Page: JobRegistration', NavApp.GetResourceAsText('JobRegistrationTweak.xml'));
    end;
    ...
    begin
        AddMessages(_LanguageCode, _Messages);
    end;
    ...
    local procedure AddMessages(_LanguageCode: Code[10]; var _Messages: Record "MOB Message")
    var
